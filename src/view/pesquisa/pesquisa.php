<title>Library - <?php  if ($listaLivro == null) {echo "Nenhum resultado encontrado";} else { echo "Pesquisa " . $_GET['searchNav'];}?></title>
    ...
    ?>
        <div class="livro">
            ...
            <div class="sobre">
                ...
                <div class="verMais">
                    <a class="visualizar" href="/livro?id=<?php echo $list->getId(); ?>">Ver Livro</a>
                </div>
            </div>
        </div>
    <?php } ?>
